        ...
        <form id="order-form" action="{{ route('order.create') }}" method="POST">
            <div class="flex w-95">
                <div class="invoice-section card">
                    ...
                    <div class="mb-4">
                        <div class="flex justify-between">
                            ...
                            <input type="text" name="name" id="name" value="{{ Auth::user()->name}}" class="input" readonly required>
                            </div>

                            <div class="w-33">
                            <label for="email" class="label">Email: <span style="color: red;">*</span></label>
                            <input type="email" name="email" id="email" value="{{ Auth::user()->email}}" class="input" readonly required>
                            </div>

                            <div class="w-33">
                            <label for="phone" class="label">Phone number: <span style="color: red;">*</span></label>
                            <input type="email" name="phone" id="phone" class="input" placeholder="Enter phone number" required>
                            </div>
                ...
                <div class="payment-section card">
                    ...
                    <button class="payment-method-button" id="cashOnDeliveryBtn">
                        <a href="#" class="flex"><img src="img/cod.jpg" alt="cash-on-delivery"><span class="cod pay">Cash On Delivery</span></a>
                    </button> 
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        // Find the Cash On Delivery button by its ID
        ...
        cashOnDeliveryBtn.addEventListener("click", function (event) {
            ...
            // Find the hidden input for the payment method by its ID
            var paymentMethodInput = document.getElementById("payment_method");

            // Set the value to "Cash On Delivery"
