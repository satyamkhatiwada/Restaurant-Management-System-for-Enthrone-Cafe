<div class="flex">
    ...
    <div class="content mt-16" style="height:1000px;">
        ...
        <div style="margin-left:20%;">
            <h1 class="emp-text">Add Inventory item</h1>
            <form action="{{ route('storeInventory') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="unit" id="category" class="form-control" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="phone" name="phone" class="form-control" max-length="10" required>
                </div>
